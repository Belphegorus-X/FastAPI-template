...
class GroupUsers(Base):
    ...
    group_id: Mapped[str] = mapped_column(
        Uuid(as_uuid=False), ForeignKey("groups.group_id"), nullable=False, primary_key=True,
    )
    user_id: Mapped[str] = mapped_column(
        Uuid(as_uuid=False), ForeignKey("user_accounts.user_id"), nullable=False, primary_key=True,
    )
